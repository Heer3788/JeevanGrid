...
from .models import LiveSession, TelemetrySample, ControlCommand, ForecastModel


class LiveRecordAdmin(admin.ModelAdmin):
...
for model in [LiveSession, TelemetrySample, ControlCommand, ForecastModel]:
    admin.site.register(model, LiveRecordAdmin)
