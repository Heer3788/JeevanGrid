...
3. Enter a complete request. For example: “Generate a plan for this site using live weather and export a PDF report.” Weather source is required. Historical NASA planning also requires a date. To test site creation without several follow-ups, use: “Create a site named Ahmedabad Test Grid in Ahmedabad district, Gujarat, latitude 23.0225, longitude 72.5714, timezone Asia/Kolkata. I explicitly accept the demo equipment template.”
